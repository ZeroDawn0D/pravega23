...
<div class = 'content-stuff'>
    <div class = "culturals_navbar">
        <ul class = "ul">
            ...
            <li class = 'li'><a href="/pdf/footprints p1.pdf">Rules</a></li>
    ...
    <dic class = 'desc_mobile'>
        <h2>Proscenium and Footprints</h2><br>
            <p>Experience Proscenium and Footprints: a stage where beautiful stories come to life. Visual depictions of scenes tug at our heart strings and bring us all together in a collective experience of humanity. We believe stage and street plays have the power to influence minds with the elegant art of expression. 
                Join us to experience creativity put in the form of theatre and street play as a part of these events.
            </p><br>
    ...
    <div class = "main_image">
        <div class = "desc">
            <h2>Proscenium and Footprints</h2>
            <p>Experience Proscenium and Footprints: a stage where beautiful stories come to life. Visual depictions of scenes tug at our heart strings and bring us all together in a collective experience of humanity. We believe stage and street plays have the power to influence minds with the elegant art of expression. 
                Join us to experience creativity put in the form of theatre and street play as a part of these events.<br><br>
    ...
    <div class = "details">
        ...
        <div class = "text">
            ...
            <div class = "rules">
                <h1>Rules</h1><br>
                <p> Click <a href ='/pdf/footprints p1.pdf'>here</a> for the rules and regulations PDF.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class = 'coords' id = 'contact'>
        ...
        <div class = "flex-images">
            <div class = "image_1">
                <h2>Adithya Ponnuraj</h2>
                <p>+91 73496 72927<br>padithya@iisc.ac.in</p>
            </div>
            <div class = "image_2">
                <h2>Anant Ashish</h2>
                <p>+91 94926 20588<br>ananthashish@iisc.ac.in</p>
            </div>
            <!--<div class = "image_3">
                <h2>Coordinator 3</h2>
                <p>Contact Info</p>-->
...
.image_1{
    height: 100vh;
    width: 32vw;
    background-image: url("/img/people/unknown.jpeg");
    background-repeat: no-repeat;
...
.image_2{
    height: 100vh;
    width: 32vw;
    background-image: url("/img/people/ashish.jpg");
    background-repeat: no-repeat;
    background-position: center;
    background-size: cover;
}
