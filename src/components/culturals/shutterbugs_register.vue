...
<div :class = "`title-flex`">
		...
		<div :class = "`content`">
			<div data-tf-widget="cP527TJD" data-tf-opacity="100" data-tf-iframe-props="title=Shutterbugs" data-tf-transitive-search-params data-tf-medium="snippet" style="width:100%;height:500px;"></div>
	</div>
</div>    
</template>
