...
<div class = 'content-stuff'>
    <div class = "culturals_navbar">
        <ul class = "ul">
            ...
            <li class = 'li'><a href="/pdf/Eleganté.pdf">Rules</a></li>
    ...
    <dic class = 'desc_mobile'>
        <h2>Elegante</h2><br>
            <p>Calling all designers and models with a passion for fashion! It's time to take center stage and showcase your creativity at IISc Pravega's new fashion event. With a themed collection to bring to life, designers will have the opportunity to let their imaginations run wild and create something truly extraordinary. As for models, this is your chance to show off your unique style and personality on the runway. With an electric atmosphere and audience, this will be an experience you won't forget. 
                Don't miss out on the chance to be a part of something truly special -be sure to join us at Eleganté.
            </p><br>
    ...
    <div class = "main_image">
        <div class = "desc">
            <h2>Elegante</h2>
            <p>Calling all designers and models with a passion for fashion! It's time to take center stage and showcase your creativity at IISc Pravega's new fashion event. With a themed collection to bring to life, designers will have the opportunity to let their imaginations run wild and create something truly extraordinary. As for models, this is your chance to show off your unique style and personality on the runway. With an electric atmosphere and audience, this will be an experience you won't forget. 
                Don't miss out on the chance to be a part of something truly special -be sure to join us at Eleganté.<br><br>
...
.main_image{
    background-image: url("/img/culturals/elegante_img1.jpg");
...
.img{
    height: 90vh;
    width: 40vw;
    background-image: url("/img/culturals/elegante_img2.jpg");
    background-repeat: no-repeat;
...
.image_1{
    height: 100vh;
    width: 32vw;
    background-image: url("/img/people/Vivedha Poorna .png");
    background-repeat: no-repeat;
...
.image_2{
    height: 100vh;
    width: 32vw;
    background-image: url("/img/people/Arushi Kaul.png");
    background-repeat: no-repeat;
    background-position: center;
    background-size: cover;
}
