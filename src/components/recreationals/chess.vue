...
<div class = 'content-stuff'>
    <div class = "culturals_navbar">
        <ul class = "ul">
            ...
            <li class = 'li'><a href="/pdf/ChessV2.pdf">Rules</a></li>
    ...
    <div class = "main_image"> <!--Render size: 2612px-->
        <div class = "desc">
            <h2>Chess </h2>
            <p><br><br>
            <router-link to="/recreationals/chess_register" :style="`text-decoration: none; color: inherit;`">
    ...
    <div class = "details">
        ...
        <div class = "text">
            <div class = "timeline">
                ...
                <p>Dates: <br></p>
                <ul>
                    <li>Blitz Arena Tournament : August 5, Saturday, 10:30 AM IST.</li>
                    <li>Rapid Swiss Tournament : August 6, Sunday, 10:30 AM IST.</li>
                </ul>
                
            </div>
            <div class = "eligibility">
                <h1>Eligibility</h1><br>
                <p>  Valid Lichess.org Account: All participants must have an active and unbanned Lichess account.
                </p>
            </div>
            
            <div class = "rules">
                <h1>Rules</h1><br>
                <p> Click <a href ='/pdf/ChessV2.pdf'>here</a> for rules and regulations pdf.
                </p>
            </div>

            <div class = "rules" id = "contact">
                <h1>Contact</h1><br>
                    pravegachesscup2023@gmail.com
            </div>
        </div>
    </div>
    <br>
...
.main_image{
    background-image: url("/img/recreationals/chess2.jpg");
...
.img{
    height: 90vh;
    width: 40vw;
    background-image: url("/img/recreationals/chess.jpg");
    background-repeat: no-repeat;
