...
export default{
  ...
  icon: 'info',
  title: 'Important',
  text: 'Submission deadline has been extended to November 10th',
  })
    },
}
</script>
...
<template>
    <div class="content-stuff">
        ...
        <div class="scitech-navbar">
            <ul>
                <li><a href="/pdf/PIS_RulesAndRegulations.pdf">Rules</a></li>
        ...
        <div class="intro">
            ...
            <div class="intro-image">
                <img src="/img/scitech/PIS.jpg" alt="scitech">
            </div>
        </div>
...
The submission end date of prelims is November 10th, the prelims entry would be a Pitch-Desk and a video with a 5-minute limit.<br>
...
There is no registration fees for the event<br> Note: Submissions for PIS have been extended to Septermber 10<sup>th</sup>.
                ...
                <div class="rules">
                <h1>Rules</h1>
                <p>You can find the rules <a href = "/pdf/PIS_RulesAndRegulations.pdf">here</a></p>
                </div>
                <div class="prizes">
                    <h1>Prizes</h1><br>
        ...
        <div class="coords">
            ...
            <div class="coord">
                <div class="coord-img">
                    <img src="\img\scitech\sahib_PIS_photu.jpg" alt="scitech">
                </div><br>
                <div class="coord-text">
                    <h1>Sahib Gangarh</h1>
                    <p>Mail: pis[dot]pravega[at]gmail[dot]com</p>
                </div>
            </div>
            <div class="coord">
                <div class="coord-img">
                    <img src="\img\scitech\ritesh_photo_PIS.jpg" alt="scitech">
                </div><br>
                <div class="coord-text">
                    <h1>Ritesh Meena</h1>
                    <p>Mail: pis[dot]pravega[at]gmail[dot]com</p>
        ...
        <div class="quote">
            <div class="quote-text" style="font-family: 'Times New Roman', Times, serif;">
                <p> ‘PIS the marquee Sci-Tech event of Pravega is back to give wings to your indigenous entrepreneurial ideas and expose them before professionals, market experts, and potential investors. Let your innovation fly high’
                </p>
            </div>
        </div><br><br>
